...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab7: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab7 ${OBJECTFILES} ${LDLIBSOPTIONS} -lX11
...
${OBJECTDIR}/ResAddr.o: ResAddr.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResAddr.o ResAddr.cpp

${OBJECTDIR}/ResAddrList.o: ResAddrList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ResAddrList.o ResAddrList.cpp
...
${OBJECTDIR}/err_display.o: err_display.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/err_display.o err_display.cpp
